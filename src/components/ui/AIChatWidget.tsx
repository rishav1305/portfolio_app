...
const AIChatWidget = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end font-sans">
            <div
                className={`bg-white rounded-2xl shadow-2xl border border-gray-200 w-[350px] md:w-[400px] mb-4 overflow-hidden flex flex-col h-[550px] transition-all duration-200 ease-out origin-bottom-right ${isOpen ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-5 scale-95 pointer-events-none'}`}
            >
                {/* Header */}
            ...
            <button
                ...
                className={`w-14 h-14 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 z-50 hover:scale-105 active:scale-95 ${isOpen
