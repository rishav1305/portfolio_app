...
Automatic Scaling</h4>
          ...
          <div className="my-12">
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <h3 className="font-bold text-lg mb-3 text-blue-600">Token Generation API</h3>
                <div className="bg-gray-50 p-4 rounded mb-3">
                  <code className="text-sm">POST /generate_token</code>
                </div>
                <p className="text-gray-600 mb-3">
                  Generates authentication token valid for 2 hours. Required for all subsequent API calls.
                </p>
                <div className="bg-gray-50 p-4 rounded">
                  <p className="text-sm font-semibold mb-2">Environments:</p>
                  <ul className="text-sm space-y-1">
                    <li><strong>DEV:</strong> https://deagenticai.ssddev.aws.gartner.com/generate_token</li>
                    <li><strong>QA:</strong> https://deagenticai.ssdqa.aws.gartner.com/generate_token</li>
                    <li><strong>PROD:</strong> https://deagenticai.ssd.aws.gartner.com/generate_token</li>
                  </ul>
                </div>
              </div>
              
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <h3 className="font-bold text-lg mb-3 text-green-600">Value Story API</h3>
                <div className="bg-gray-50 p-4 rounded mb-3">
                  <code className="text-sm">POST /value_story/invoke</code><br/>
                  <code className="text-sm">POST /value_story/stream</code>
                </div>
                <p className="text-gray-600 mb-3">
                  Retrieves value statements and client insights. Supports both invoke and streaming modes.
                </p>
                <div className="bg-gray-50 p-4 rounded">
  ...
  "input": {
    "thread_id": "",
    "platform_id": "recoui_value_story_assistant",
    "ppl_code": "10138288",
    "emp_code": "18472",
    "user_query": "Get me value statements from last year",
    "chat_id": "",
    "logged_in_empcode": "1017354"
  }
}`}</pre>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <h3 className="font-bold text-lg mb-3 text-purple-600">QBR Agent API</h3>
                <div className="bg-gray-50 p-4 rounded mb-3">
                  <code className="text-sm">POST /qbr_agent/invoke</code>
                </div>
                <p className="text-gray-600 mb-3">
                  Quarterly Business Review agent for accessing archived documents and client data.
                </p>
                <div className="bg-gray-50 p-4 rounded">
                  <p className="text-sm font-semibold mb-2">Request Body:</p>
                  <pre className="text-xs overflow-x-auto">{`{
  "input": {
    "thread_id": "",
    "platform_id": "recoui_qbr_multiagent_assistant",
    "ppl_code": "2426788, 17910214",
    "emp_code": "112825",
    "user_query": "tell me some archived docs of AI",
    "logged_in_empcode": "123702",
    "org_code": "499629"
  }
}`}</pre>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <h3 className="font-bold text-lg mb-3 text-orange-600">Feedback API</h3>
                <div className="bg-gray-50 p-4 rounded mb-3">
                  <code className="text-sm">GET /feedback</code><br/>
                  <code className="text-sm">POST /feedback</code>
                </div>
                <p className="text-gray-600 mb-3">
                  Manages user feedback for continuous improvement. Supports both retrieval and submission.
                </p>
                <div className="bg-gray-50 p-4 rounded">
                  <p className="text-sm font-semibold mb-2">POST Request Body:</p>
                  <pre className="text-xs overflow-x-auto">{`{
  "vote": "like",
  "thread_id": "thread_id1",
  "chat_id": "chat_id1",
  "logged_in_emp_code": "123",
  "ppl_code": "234",
  "emp_code": "456",
  "feedback_comments": "test_comment"
}`}</pre>
                </div>
              </div>
            </div>
